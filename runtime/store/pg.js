...
// html/script carry a text body sidecar; content-type by type. (binary will store its own mime.)
const BODY_CONTENT_TYPE = { script: 'text/javascript', html: 'text/html; charset=utf-8' }
