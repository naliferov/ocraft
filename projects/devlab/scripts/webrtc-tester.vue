...
const connectWs = () => {
  ...
  ws.onclose = (e) => {
    ...
    logLine(`ws closed (code ${e.code})${e.code === 1006 ? ' — cross-origin? cookie/auth likely rejected' : ''}`)
  }
...
<template>
  <div class="flex max-w-3xl flex-col gap-3">
    <div class="flex items-center gap-2">
      <input v-model="wsUrl" class="input input-sm input-bordered flex-1 font-mono" placeholder="wss://host/ws" @keydown.enter="connectWs" />
